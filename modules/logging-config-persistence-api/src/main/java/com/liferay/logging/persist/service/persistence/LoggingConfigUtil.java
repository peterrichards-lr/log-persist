...
public class LoggingConfigUtil {
	 ...
	 */
	public static Map<Serializable, LoggingConfig> fetchByPrimaryKeys(
	 ...
	 */
	public static LoggingConfig update(
		LoggingConfig loggingConfig, ServiceContext serviceContext) {
	 ...
	 */
	public static LoggingConfig findByLogger(String logger)
		throws com.liferay.logging.persist.exception.
			NoSuchLoggingConfigException {
	 ...
	 */
	public static LoggingConfig fetchByLogger(String logger) {
	 ...
	 * @return the matching logging config, or <code>null</code> if a matching logging config could not be found
	 */
	public static LoggingConfig fetchByLogger(
		String logger, boolean useFinderCache) {

		return getPersistence().fetchByLogger(logger, useFinderCache);
	}
	 ...
	 */
	public static LoggingConfig removeByLogger(String logger)
		throws com.liferay.logging.persist.exception.
			NoSuchLoggingConfigException {
	 ...
	 */
	public static int countByLogger(String logger) {
	...
	private static volatile LoggingConfigPersistence _persistence;
